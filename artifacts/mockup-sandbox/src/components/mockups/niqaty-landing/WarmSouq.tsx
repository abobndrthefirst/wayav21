...
export default function WarmSouq() {
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8 relative">
            ...
            <FadeIn delay={400} className="flex flex-col sm:flex-row gap-4 sm:gap-6 pt-4 sm:pt-8">
              ...
              <button
                ...
                className="bg-transparent text-[#C05C30] border-[2px] border-[#C05C30] px-6 sm:px-8 py-4 sm:py-5 text-lg sm:text-xl font-bold hover:bg-[#FFF6E8] transition-all transform hover:-translate-y-2 hover:-rotate-2 shadow-[8px_8px_0px_#2B1708] relative"
              >
                {t.hero.secondaryCta}
              </button>
            </FadeIn>
              ...
              return (
                <FadeIn key={i} delay={i * 100} className="h-full">
                  <div className={`p-6 sm:p-8 rounded-3xl border-[3px] border-[#2B1708] h-full flex flex-col justify-center relative hover:scale-105 transition-transform duration-300 ${styles[i]}`}>
                    <div className="absolute top-4 right-4 w-12 sm:w-16 h-12 sm:h-16 rounded-full border-[3px] border-current flex items-center justify-center font-black text-xl sm:text-2xl opacity-50 transform rotate-12 bg-[#FFF6E8] text-[#2B1708]">
                      {i + 1}
                    </div>
                    <h3 className={`text-xl sm:text-3xl font-black mb-3 sm:mb-4 uppercase ${isRtl ? 'pl-16' : 'pr-16'}`}>{step.title}</h3>
