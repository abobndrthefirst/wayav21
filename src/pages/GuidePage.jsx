...
const CONTENT = {
  en: {
    ...
    steps: [
      ...
      { h: 'Enter the customer\'s phone number', b: 'Type their phone number (with country code, e.g. +9665…). Their loyalty card opens automatically.' },
  ...
  ar: {
    ...
    steps: [
      ...
      { h: 'أدخل رقم جوال العميل', b: 'اكتب رقم جواله مع مفتاح الدولة (مثلاً +9665…). بطاقته تفتح تلقائياً.' },
  ...
  ur: {
    ...
    steps: [
      ...
      { h: 'گاہک کا فون نمبر درج کریں', b: 'کنٹری کوڈ کے ساتھ نمبر لکھیں (مثلاً +9665…)۔ ان کا لائلٹی کارڈ خود بخود کھل جائے گا۔' },
  ...
  hi: {
    ...
    steps: [
      ...
      { h: 'ग्राहक का फ़ोन नंबर डालें', b: 'कंट्री कोड के साथ नंबर टाइप करें (जैसे +9665…)। उनका लॉयल्टी कार्ड अपने आप खुल जाएगा।' },
  ...
  bn: {
    ...
    steps: [
      ...
      { h: 'গ্রাহকের ফোন নম্বর দিন', b: 'কান্ট্রি কোডসহ নম্বর টাইপ করুন (যেমন +9665…)। তাদের লয়্যালটি কার্ড স্বয়ংক্রিয়ভাবে খুলবে।' },
