...
export default function WarmSouqAffordance() {
  ...
  return (
    ...
    >
          ...
          {t.stats.map((stat, i) => {
            ...
            return (
              <div key={i} className="relative">
                ...
                <FadeIn delay={i * 100}>
                  <div className={`${bgColors[i]} border-[3px] border-[#2B1708] p-4 sm:p-8 rounded-2xl shadow-[8px_8px_0px_#2B1708] transform ${rotations[i]} hover:rotate-0 hover:-translate-y-2 transition-all duration-300 text-center relative overflow-hidden group cursor-default`}>
                    ...
                    <div className={`text-xs sm:text-lg md:text-xl font-bold ${textColors[i]} uppercase tracking-widest relative z-10 bg-[#FFF6E8]/10 py-1 sm:py-2 rounded-lg border-[3px] border-transparent group-hover:border-current transition-colors inline-block px-2 sm:px-4`}>
                      {stat.label}
                    </div>
                  </div>
                </FadeIn>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <FadeIn>
            <div className="text-center mb-12 sm:mb-20 relative inline-block mx-auto w-full">
              <h2 className={`text-3xl sm:text-5xl md:text-7xl font-black ${titleFont} uppercase tracking-tighter inline-block relative bg-[#2B1708] text-[#FCF0DC] px-4 sm:px-8 py-2 sm:py-4 border-[3px] border-[#FCF0DC] shadow-[12px_12px_0px_#2B1708] transform -rotate-1`}>
                {t.howItWorks.title}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 relative">
            {t.howItWorks.steps.map((step, i) => {
              ...
              return (
                <FadeIn key={i} delay={i * 100} className="h-full relative">
                  <div className={`p-6 sm:p-8 rounded-3xl border-[3px] border-[#2B1708] h-full flex flex-col justify-center relative hover:scale-105 transition-transform duration-300 ${styles[i]} cursor-pointer`}>
                    <div className="text-4xl sm:text-5xl font-black text-[#C05C30] mb-2">{isRtl ? toArabicNumerals(i + 1) : i + 1}</div>
                    <h3 className={`text-xl sm:text-3xl font-black mb-3 sm:mb-4 uppercase`}>{step.title}</h3>
                    <p className="text-base sm:text-lg font-bold opacity-80 border-t-[3px] border-current pt-3 sm:pt-4 border-dashed">{step.desc}</p>
                    {i < t.howItWorks.steps.length - 1 && (
                      <div className={`absolute ${isRtl ? 'left-[-40px]' : 'right-[-40px]'} top-1/2 -translate-y-1/2 z-20 hidden lg:block`}>
                        <div className="border-t-4 border-dashed border-[#D4963B] w-12 opacity-50"></div>
                      </div>
                    )}
                  </div>
                </FadeIn>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <FadeIn>
            <div className="flex flex-col items-center mb-12 sm:mb-24">
              <span className="bg-[#FFF6E8] text-[#C05C30] font-black px-4 sm:px-6 py-2 rounded-full border-[3px] border-[#2B1708] mb-4 sm:mb-6 transform -rotate-3 inline-block text-sm sm:text-base">{t.phone.whoUses}</span>
              <h2 className={`text-3xl sm:text-5xl md:text-7xl font-black ${titleFont} text-center uppercase tracking-tighter text-[#2B1708] relative inline-block`}>
                {t.businesses.title}
            ...
            {t.businesses.items.map((item, i) => {
              ...
              return (
                <FadeIn key={i} delay={i * 50}>
                  <div className={`p-4 sm:p-6 border-[3px] border-[#2B1708] shadow-[6px_6px_0px_#2B1708] transform ${rotate} hover:scale-110 hover:z-20 transition-all duration-300 relative group ${color} cursor-pointer`}>
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn>
            <div className="mb-12 sm:mb-20">
              <h2 className={`text-3xl sm:text-5xl md:text-7xl font-black ${titleFont} uppercase tracking-tighter text-[#2B1708]`}>
                {t.features.title}
                <span className="text-[#C05C30] inline-block transform rotate-12 ml-2 sm:ml-4">!</span>
              </h2>
            </div>
          </FadeIn>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 auto-rows-[200px] sm:auto-rows-[250px]">
            {t.features.items.map((item, i) => {
              ...
              return (
                ...
                >
                  <div className={`${bgClass} p-5 sm:p-8 border-[3px] border-[#2B1708] shadow-[8px_8px_0px_#2B1708] h-full flex flex-col hover:-translate-y-2 hover:shadow-[12px_12px_0px_#2B1708] transition-all duration-300 relative overflow-hidden group cursor-pointer`}>
      ...
      <section ref={waitlistRef} id="waitlist" className="py-20 sm:py-32 bg-[#FFF6E8] px-4 sm:px-6 relative overflow-hidden text-center">
        <div className="absolute top-20 left-[10%] text-4xl sm:text-6xl transform -rotate-12 animate-float hidden sm:block" aria-hidden="true">🚀</div>
        <div className="absolute bottom-20 left-[20%] text-3xl sm:text-5xl transform rotate-45 animate-float-delayed hidden sm:block" aria-hidden="true">🔥</div>
        <div className="absolute top-32 right-[15%] text-5xl sm:text-7xl transform rotate-12 animate-float hidden sm:block" aria-hidden="true">🎉</div>
        <div className="absolute bottom-32 right-[25%] text-3xl sm:text-5xl transform -rotate-12 animate-float-delayed hidden sm:block" aria-hidden="true">👋</div>
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  >
                    <input
                      ...
                      dir={isRtl ? 'rtl' : 'ltr'}
                      className="flex-1 w-full bg-[#FFF6E8] px-5 sm:px-8 h-[56px] text-base sm:text-xl outline-none border-[3px] border-[#2B1708] focus:ring-4 focus:ring-[#C05C30]/30 transition-all font-bold placeholder:text-[#4A2E18]/50 text-[#2B1708]"
                    />
                    <div className="w-full sm:w-auto flex flex-col items-center">
                      <button
                        type="submit"
                        className="w-full bg-[#C05C30] text-white px-6 sm:px-10 h-[56px] text-base sm:text-xl font-bold border-b-[6px] border-r-[4px] border-t-[2px] border-l-[2px] border-[#2B1708] active:translate-y-1 active:translate-x-1 active:border-b-[2px] active:border-r-[2px] transition-all flex items-center justify-center gap-3 uppercase whitespace-nowrap"
                      >
                        {isRtl && <ArrowLeft className="w-5 h-5" />}
                        {t.waitlist.button}
                        {!isRtl && <ArrowRight className="w-5 h-5" />}
                      </button>
                      <span className="text-sm font-bold text-[#4A2E18]/70 mt-2 block w-full text-center">
                        {isRtl ? "✓ يصلك رد خلال ٢٤ ساعة" : "✓ We'll respond within 24 hours"}
                      </span>
                    </div>
                  </form>
                  {formError && (
                  ...
                  <div className="flex items-center justify-center gap-4 pt-2">
                    <div className="h-[3px] bg-[#2B1708]/10 flex-1"></div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-3 bg-[#25D366] text-white px-6 sm:px-10 h-[56px] text-base sm:text-xl font-bold border-b-[6px] border-r-[4px] border-t-[2px] border-l-[2px] border-[#2B1708] active:translate-y-1 active:translate-x-1 active:border-b-[2px] active:border-r-[2px] transition-all w-full sm:w-auto"
                  >
      ...
      <div style={{ position: 'fixed', bottom: '16px', left: '16px', background: '#2B1708', color: '#FCF0DC', padding: '8px 12px', fontSize: '11px', borderRadius: '4px', zIndex: 999, opacity: 0.85 }}>
        Tradeoff: affordance clarity — every interactive element signals its interactivity; less minimal
      </div>
    </div>
  );
}
